...
const slides: Slide[] = [
  ...
  { id: 28, type: 'workshop', title: 'Trust Design Workshop', case: 'AI Robo Advisor', situation: <>An AI-powered “robo-advisor” analyzes the market and gives users investment recommendations. Consider two different users:<br /><br /><b>User A (The Skeptic):</b> An experienced investor who ignores the AI’s data-driven advice to sell a declining stock, trusting their “gut feeling.” (Algorithm Aversion).<br /><br /><b>User B (The Believer):</b> A novice investor who accepts the AI’s advice to put their life savings into a high-risk fund without a second thought (Over-reliance).</>, task: 'Design a "Calibration" Intervention: Propose one transparent, agency-respecting AI feature for both users (e.g., An "Explain the Risk" button showing the recommendation, confidence, data, and a critical prompt).', questions: ['Diagnose Psychological Risk: State each user\'s main psychological risk in one sentence.', 'Calibration & Outcome: How does the feature help the skeptic accept data while encouraging the believer to think critically?'] },
